...
class Cart extends Model{
	...
	public function getProductsTotals(){
		...
		$results = $sql->select("SELECT SUM(vlprice) AS vlprice, SUM(vlwidth) AS vlwidth, 
			...
			COUNT(*) AS nrqtd FROM tb_products a INNER JOIN tb_cartsproducts b ON a.idproduct = b.idproduct
	...
	//Metodo implementado para corrigir o erro do carrinho salvo em outro login da mesma sessão
